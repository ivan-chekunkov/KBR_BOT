...
def _load_json(file_name: str, logger: logging.Logger, cls_mode: bool,
               encoding: str) -> dict | None:
...
def _valid_settings(cheking_settings: dict | list, logger: logging.Logger,
                    settings: dict):
    try:
...
def load(file_name: str = 'settings.json',
         cls_mode: bool = True,
         log: bool = True,
         handler: str = 'fc',
         encoding: str = 'UTF-8',
         need_to_check: bool = False,
         cheking_settings: dict | list | None = None) -> dict | None:
